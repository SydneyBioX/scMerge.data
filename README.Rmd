...
`scMerge.data` contains an illustrative data to demonstrate the utility of the `scMerge` package. For more details, please see here: https://github.com/SydneyBioX/scMerge. 

This package is a convenient way to load the data stored [here](http://www.maths.usyd.edu.au/u/yingxinl/wwwnb/scMergeData/sce_mESC.rda).
